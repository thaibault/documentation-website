...
ga('create', '{1}', 'github.io');ga('send', 'pageview');"
    ...
    # region protected properties 
        ...
        _options: {}
        ###*
            Saves default options for extending usually overridden options
            object.
    ...
    # region public methods
        ...
        initialize: (options) ->
            ...
            )._addMediaQueryChangeEvents()._triggerWindowResizeEvents(
            )._handleGoogleAnalytics(this._options.trackingCode)
    ...
    # region protected methods
        ...
        _addNavigationEvents: ->
            this._domNodes.window.hashchange(=>
                this.fireEvent 'switchSection', false, this,
